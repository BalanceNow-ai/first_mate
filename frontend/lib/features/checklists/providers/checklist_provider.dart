...
final vesselChecklistsProvider = FutureProvider.family<
    List<Map<String, dynamic>>, String>((ref, vesselId) async {
  final apiService = ref.read(apiServiceProvider);
  return apiService.getVesselChecklists(vesselId);
});

/// Generate checklists for a vessel.
final generateChecklistsProvider =
    FutureProvider.family<Map<String, dynamic>, String>((ref, vesselId) async {
  final apiService = ref.read(apiServiceProvider);
